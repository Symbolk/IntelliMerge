            ...
            for (ClassOrInterfaceDeclaration classOrInterfaceDeclaration : classOrInterfaceDeclarations) {
                ...
                for (MethodDeclaration methodDeclaration : methodDeclarations) {
                    ...
                    for (FieldAccessExpr fieldAccessExpr : fieldAccessExprs) {
                        ...
                        ResolvedFieldDeclaration resolvedFieldDeclaration = ref.getCorrespondingDeclaration().asField();
                        displayName = resolvedFieldDeclaration.getName();
                        qualifiedName = resolvedFieldDeclaration.declaringType().getQualifiedName() + "." + resolvedFieldDeclaration.getName();
                        SemanticNode resolvedFieldDeclNode = new SemanticNode(count++, NodeType.FIELDDECLARATION, displayName, qualifiedName, "");
                        System.out.println(
                                "!!" + resolvedFieldDeclaration.declaringType().getQualifiedName() + "." + resolvedFieldDeclaration.getName());
                    }
