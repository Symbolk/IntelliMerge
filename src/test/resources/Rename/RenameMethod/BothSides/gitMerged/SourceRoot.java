...
public class SourceRoot {
     ...
     */
<<<<<<< F:\workspace\dev\IntelliMerge\src\test\resources\Rename\RenameMethod\BothSides\gitMerged\SourceRoot.java
...
||||||| F:\workspace\dev\IntelliMerge\src\test\resources\Rename\RenameMethod\BothSides\base\SourceRoot.java
    public Map<Path, ParseResult<CompilationUnit>> tryToParse(JavaParser parser) throws IOException {
        return tryToParse("", parser);
=======
    public Map<Path, ParseResult<CompilationUnit>> tryToParse(JavaParser parser) throws IOException {
        return tryToParsePackage("", parser);
>>>>>>> F:\workspace\dev\IntelliMerge\src\test\resources\Rename\RenameMethod\BothSides\theirs\SourceRoot.java
    }
