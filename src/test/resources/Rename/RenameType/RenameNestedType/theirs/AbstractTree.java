...
public abstract class AbstractTree implements ITree {
    ...
    public static class DummyTree extends AbstractTree {
        ...
        public DummyTree(ITree... trees) {
            children = new ArrayList<>(trees.length);
            children.addAll(Arrays.asList(trees));
        }

        private RuntimeException unsupportedOperation() {
            return new UnsupportedOperationException("This terminal should not be called on a fake tree");
        }
